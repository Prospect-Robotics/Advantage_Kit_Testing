...
public class ModuleIOSim implements ModuleIO {
  ...
  private static final double DRIVE_KS = 0.00467;
  private static final double DRIVE_KV_ROT =
      0.83397; // Same units as TunerConstants: (volt * secs) / rotation
  private static final double DRIVE_KV = 1.0 / Units.rotationsToRadians(1.0 / DRIVE_KV_ROT);
  // NOTE: Might wanna set this to 0.83397, and set the one before to 0.91035.
